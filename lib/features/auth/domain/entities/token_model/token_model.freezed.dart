...
@override
String toString() {
  return 'TokenModel(accessToken: $accessToken, refreshToken: $refreshToken, expiredAt: $expiredAt, customer: $customer)';
}
...
class _TokenModel implements TokenModel {
  const _TokenModel({this.accessToken, this.refreshToken, @DateTimeStringOrNullSerializer() this.expiredAt, this.customer});
