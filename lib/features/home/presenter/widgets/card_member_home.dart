...
class CardMemberHome extends StatelessWidget {
        ...
        return Stack(
          ...
          children: [
            ...
            Container(
              ...
              height: Responsive.sizex(context, mobile: 140, tablet: 155),
              ...
              child: _childContent(context, state),
            ),
          ],
        );
      },
  ...
  Container _childContent(BuildContext context, ProfileState state) {
    final _customer = state.profile;
    final _level = _customer.level == 0 ? 1 : _customer.level;
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  spacing: 8,
                  children: [
                    Flexible(child: Text(_tierLabel, style: _tierStyle)),
